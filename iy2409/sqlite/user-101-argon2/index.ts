...
function addUser() {
  rl.question('Enter username: ', (username) => {
    rl.question('Enter password: ', async (password) => {
      const passwordHash = await argon2.hash(password); // Hash the password using argon2
...
function updateUserPassword() {
  rl.question('Enter user ID: ', (id) => {
    rl.question('Enter new password: ', async (newPassword) => {
      const newPasswordHash = await argon2.hash(newPassword); // Hash the password using argon2
